...
|-----|-------|---------|-------|
| **LOS Wallet** | [LOS-Wallet-2.0.1-mainnet-macos.dmg](https://github.com/monkey-king-code/unauthority-core/releases/download/wallet-v2.0.1-mainnet/LOS-Wallet-2.0.1-mainnet-macos.dmg) | [LOS-Wallet-2.0.1-mainnet-windows-x64.zip](https://github.com/monkey-king-code/unauthority-core/releases/download/wallet-v2.0.1-mainnet/LOS-Wallet-2.0.1-mainnet-windows-x64.zip) | [LOS-Wallet-2.0.1-mainnet-linux-x64.tar.gz](https://github.com/monkey-king-code/unauthority-core/releases/download/wallet-v2.0.1-mainnet/LOS-Wallet-2.0.1-mainnet-linux-x64.tar.gz) |
| **LOS Validator Node** | [LOS-Validator-2.0.1-mainnet-macos.dmg](https://github.com/monkey-king-code/unauthority-core/releases/download/validator-v2.0.1-mainnet/LOS-Validator-2.0.1-mainnet-macos.dmg) | [LOS-Validator-2.0.1-mainnet-windows-x64.zip](https://github.com/monkey-king-code/unauthority-core/releases/download/validator-v2.0.1-mainnet/LOS-Validator-2.0.1-mainnet-windows-x64.zip) | [LOS-Validator-2.0.1-mainnet-linux-x64.tar.gz](https://github.com/monkey-king-code/unauthority-core/releases/download/validator-v2.0.1-mainnet/LOS-Validator-2.0.1-mainnet-linux-x64.tar.gz) |
